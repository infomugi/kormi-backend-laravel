...
@php
    $sizeClasses = [
        ...
        'default' => 'px-3.5 sm:px-5 py-2.5 sm:py-3.5 text-xs sm:text-sm rounded-xl sm:rounded-2xl',
    ][$size] ?? 'px-3.5 sm:px-5 py-2.5 sm:py-3.5 text-xs sm:text-sm rounded-xl sm:rounded-2xl';
@endphp
