...
class Dashboard extends Component
{
    public function render()
    {
        ...
        $sdiJadwal = \App\Models\SdiJadwal::with('program')->limit(2)->get();
        $apmoTerbaru = \App\Models\ApmoPenerima::with('tahun')->limit(3)->get();
        ...
        $kordikAktif = \App\Models\KordikPengurus::where('status_aktif', true)->count();
